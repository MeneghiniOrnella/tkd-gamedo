...
const cuestionary = [
    ...
    {
        'question': 'Finalizaste el juego',
        'answers': ['Puedes volver a jugar o compartir captura de pantalla de tu puntaje.']
    },
];
...
const evaluateAnswer = (answer,obj) =>{
    ...
    if(total == 15){
        let finishText = document.write(`<div class="end"><p class="finish">Fin!</p><br><p>Juega de nuevo o comparte tus resultados con tus compañeros.</p></div>`);
    } else{
